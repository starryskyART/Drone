...
#define Joystick_Task_STACK_SIZE 128 // Joystick_Task
...
#define Joystick_Task_Period 20 // Joystick_Task每20ms执行一次
...
void App_RTOS_Start(void)
{
    ...
    // 创建遥感任务
    xTaskCreate(Joystick_Task, "Joystick_Task", Joystick_Task_STACK_SIZE, NULL, Joystick_Task_PRIORITY, &Joystick_Task_Handler);
    // 启动调度器
    vTaskStartScheduler();
}
